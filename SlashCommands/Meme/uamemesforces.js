...
module.exports = {
    ...
    .setName("uamemesforces")
    .setDescription("Honestly don't run this."),

    run: async (client, interaction, args) => {

        await interaction.reply(`Searching the internet for whatever this is <a:loading:1026905223031173150>`)

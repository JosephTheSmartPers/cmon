...
client.on("messageDelete", (message) => {
  mdelete(Discord, client, message);
});
client.on("messageUpdate", (oldMessage, newMessage) => {
  if (newMessage) mupdate(Discord, client, oldMessage, newMessage);
});
client.on("channelDelete", (channel) => {
  if (channel.guild) cdelete(Discord, client, channel);
});
client.on("channelCreate", (channel) => {
  if (channel.guild) ccreate(Discord, client, channel);
});
client.on("channelPinsUpdate", (channel, time) => {
  if (channel.guild) cpinsupdate(Discord, client, channel);
});
client.on("channelUpdate", (oldChannel, newChannel) => {
  if (newChannel.guild) cupdate(Discord, client, oldChannel, newChannel);
});
client.on("emojiCreate", (emoji) => {
  if (emoji.guild) ecreate(Discord, client, emoji);
});
client.on("emojiDelete", (emoji) => {
  if (emoji.guild) edelete(Discord, client, emoji);
});
client.on("emojiUpdate", (oldEmoji, newEmoji) => {
  if (newEmoji.guild) eupdate(Discord, client, oldEmoji, newEmoji);
});
client.on("guildBanAdd", (ban) => {
  if (ban.guild) gbanadd(Discord, client, ban);
});
client.on("guildBanRemove", (ban) => {
  if (ban.guild) gbanremove(Discord, client, ban);
});
client.on("guildMemberAdd", (member) => {
  if (member.guild) gmemberadd(Discord, client, member);
});
client.on("guildMemberRemove", (member) => {
  if (member.guild) gmemberremove(Discord, client, member);
});
client.on("guildMemberUpdate", (oldMember, newMember) => {
  if (newMember.guild) gmemberupdate(Discord, client, oldMember, newMember);
});
client.on("guildScheduledEventCreate", (event) => {
  if (event.guild) gscheduledeventcreate(Discord, client, event);
});
client.on("guildScheduledEventDelete", (event) => {
  if (event.guild) gscheduledeventdelete(Discord, client, event);
});
client.on("guildScheduledEventUpdate", (oldevent, newevent) => {
  if (newevent.guild)
    gscheduledeventupdate(Discord, client, oldevent, newevent);
});
client.on("interactionCreate", (interaction) => {
  if (interaction.guild) icreate(Discord, client, interaction);
});
client.on("guildUpdate", (oldguild, newguild) => {
  if (newguild) gupdate(Discord, client, oldguild, newguild);
});
client.on("voiceStateUpdate", (oldState, newState) => {
  if (newState.guild) vstateupdate(Discord, client, oldState, newState);
});

client.on("messageCreate", (message) => {
  login(Discord, client, message);
});
